    ...
    <>
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-indigo-950 via-purple-900 to-blue-950 py-28">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-5xl lg:text-6xl font-extrabold text-white mb-6 leading-tight" data-testid="text-about-headline">
      ...
      <section className="py-14 bg-white border-b border-gray-100">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-5 gap-6">
            {TEAM_STATS.map((s) => (
              <div key={s.label} className="text-center group" data-testid={`stat-about-${s.label}`}>
