...
export default function WhatsAppSettingsPage() {
  ...
  const [botForm, setBotForm] = useState<ChatbotSettings>({
    ...
    botMission: "جمع بيانات العميل الكاملة (الاسم، الميزانية، نوع الوحدة، عدد الغرف، الموقع المفضل، طريقة الدفع) وترشيح وحدات مناسبة من المشاريع المتاحة قبل تحويله للسيلز.",
    companyKnowledge: "",
    respondAlways: false,
  ...
  useEffect(() => {
    if (botSettings) {
      setBotForm({
        ...
        botMission: botSettings.botMission ?? "جمع بيانات العميل الكاملة (الاسم، الميزانية، نوع الوحدة، عدد الغرف، الموقع المفضل، طريقة الدفع) وترشيح وحدات مناسبة من المشاريع المتاحة قبل تحويله للسيلز.",
            ...
            <>
              ...
              <div className="rounded-lg border border-blue-200 bg-blue-50 dark:bg-blue-900/10 p-3 space-y-1.5">
                ...
                <ul className="text-xs text-blue-600 dark:text-blue-500 space-y-1 list-disc list-inside">
                  ...
                  <li>بعد جمع البيانات، بيحيل العميل للسيلز المعيّن مع ملخص كامل</li>
                  <li>السيلز يقدر يوقف البوت لأي ليد من بانيل الليد</li>
                </ul>
              </div>
